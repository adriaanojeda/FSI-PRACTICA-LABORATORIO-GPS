...
class Node:
    ...
    def expand(self, problem):
        ...
        for (act, next) in problem.successor(self.state):
            ...
            # Contabilizar el nodo generado (Parte 3)
...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        # El código base usa un closed simple, si existe una mejor ruta
        # (menor path_cost) a un estado cerrado, NO la permite. 
        # Esto coincide con los resultados no óptimos de BFS/DFS de tu tabla.
...
def astar_search(problem):
    ...
    # problem.h(node) ya implementa la heurística euclídea
...
class GPSProblem(Problem):
    ...
    def path_cost(self, cost_so_far, A, action, B):
        # Utiliza la distancia entre los nodos del grafo de Rumanía
        return cost_so_far + (self.graph.get(A, B) or infinity) 

    def h(self, node):
        """h function is straight-line distance from a node's state to goal. 
        Esto se usa como la heurística euclídea (subestimación)."""
